...
class SleepTrackerViewModel(
        ...
        private val _navToSleepQuality = MutableLiveData<SleepNight>()
        val navToSleepQuality: LiveData<SleepNight>
                get() = _navToSleepQuality

        // button visible state based on tonight
